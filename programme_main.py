    ...
    while 1:
        try:
            ...
            if chaudiere_com_error==0:
                if etat==1:
                    photo5=PhotoImage(file="Images\chaudiere_on.png")
                    canvas5.itemconfig(item,image = photo5)
                if etat==0:   
                    photo5=PhotoImage(file="Images\chaudiere_off.png")
                    canvas5.itemconfig(item,image = photo5)
            else:
                photo5=PhotoImage(file="Images\chaudiere_error.png")
                canvas5.itemconfig(item,image = photo5)               
...
def clic(event):
    ...
    variable_etat = fenetre.winfo_x()
    update_db(variable_input, variable_etat)
    variable_input = "position_fen_y"
    variable_etat = fenetre.winfo_y()
    update_db(variable_input, variable_etat)
...
def compteur_manu ():
    ...
    if debut==0:
        ...
        tempscompteursec = int(tempscompteur - (tempscompteurmin*60))
        #mise a jour du label
...
#image frame
photo1 = PhotoImage(file=chemin+"Images\Thermo.png")
...
#image frame
photo2 = PhotoImage(file=chemin+"Images\Hygro.png")
...
label.grid(row=0, column=1,  columnspan=1, sticky="nsew")
#image frame
photo = PhotoImage(file=chemin+"Images\Thermo.png")
...
label.grid(row=0, column=1,  columnspan=1, sticky="nsew")
#image frame
photo4 = PhotoImage(file=chemin+"Images\Hygro.png")
...
#image d'etat
photo5 = PhotoImage(file=chemin+"Images\chaudiere_off.png")
...
bouton_diagnostic.bind("<Button-1>", clic)
