...
def changement_label():
    ...
    while fin_thread==0:
        ...
        etat2.configure(text = ("scrutation du r"+u"\u00E9"+"seau en cours ."))
        etat3.configure(text = ("scrutation du r"+u"\u00E9"+"seau en cours ."))
        time.sleep(0.2)
        etat1.configure(text = ("scrutation du r"+u"\u00E9"+"seau en cours .."))
        etat2.configure(text = ("scrutation du r"+u"\u00E9"+"seau en cours .."))
        etat3.configure(text = ("scrutation du r"+u"\u00E9"+"seau en cours .."))
...
def fenetre_diagnostic():
    ...
    fenetre_diag.geometry('%dx%d+%d+%d' % (800, 432, x, y))
