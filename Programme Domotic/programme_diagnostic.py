...
def changement_label():
    ...
    while fin_thread==0:
        ...
        etat1.configure(text = ("scrutation du réseau en cours ."))
        etat2.configure(text = ("scrutation du réseau en cours ."))
        etat3.configure(text = ("scrutation du réseau en cours ."))
        time.sleep(0.2)
        etat1.configure(text = ("scrutation du réseau en cours .."))
        etat2.configure(text = ("scrutation du réseau en cours .."))
        etat3.configure(text = ("scrutation du réseau en cours .."))
...
def start_diagnostic_thread():
    ...
    #communication avec température interieur
    try:
        ws = websocket.WebSocket()
        ...
        result2=0
    #communication avec température extérieur
    try:
        ws = websocket.WebSocket()
        ws.connect("ws://192.168.1.101/")
        ws.close()
...
def fenetre_diagnostic():
    ...
    bouton_fermeture = Button(visu, text="Mise à jour", command=start_diagnostic,width = 14)
